...
return [
    ...
    'except' => [
        // Sem 'api/*' a Debugbar injeta HTML no meio da resposta JSON e o
        // cliente falha com um erro de parse que nao aponta para a causa.
        'api/*',
        'telescope*',
        'horizon*',
        '_boost/browser-logs',
    ...
    */
    ...
    'collectors' => [
        ...
        'views' => env('DEBUGBAR_COLLECTORS_VIEWS', false),           // Pesado e raramente util: desligado por padrao
